 ...
 * @author DELL
 */
public class PNameSingleUI extends BorderPane{
    ...
    public PNameSingleUI() {
        ...
        lbPlayer1.setText("Enter Your Name");
        ...
        txtPlayer1.setPrefHeight(40.0);
        txtPlayer1.setMaxHeight(70);  
        txtPlayer1.setPrefWidth(475.0);
        txtPlayer1.setStyle("-fx-font-weight: bold;");
        GridPane.setHalignment(txtPlayer1, javafx.geometry.HPos.CENTER);
        GridPane.setMargin(txtPlayer1, new Insets(150.0, 0.0, 25.0, 0.0)); 
